...
use FluentSupport\Framework\Database\Orm\SoftDeletes;
...
abstract class HasOneOrManyThrough extends Relation
{
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentSupport\Framework\Database\Orm\Model| \FluentSupport\Framework\Database\Orm\Collection<int, TRelatedModel>
     *
     ...
     * @param  (\Closure(): TValue)|null  $callback
     * @return \FluentSupport\Framework\Database\Orm\Model|\FluentSupport\Framework\Database\Orm\Collection<int, TRelatedModel>|TValue
     */
