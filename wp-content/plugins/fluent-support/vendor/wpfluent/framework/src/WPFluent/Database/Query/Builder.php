...
use FluentSupport\Framework\Support\LazyCollection;
use FluentSupport\Framework\Database\Query\Expression;
use FluentSupport\Framework\Database\Query\Grammars\Grammar;
use FluentSupport\Framework\Database\Query\Processors\Processor;
use FluentSupport\Framework\Database\Query\ConditionExpression;
use FluentSupport\Framework\Support\ArrayableInterface;
use FluentSupport\Framework\Database\ConnectionInterface;
use FluentSupport\Framework\Database\Concerns\BuildsQueries;
use FluentSupport\Framework\Database\Concerns\BuildsWhereDateClauses;
use FluentSupport\Framework\Database\Concerns\ExplainsQueries;
use FluentSupport\Framework\Database\Orm\Relations\Relation;
use FluentSupport\Framework\Database\Orm\Builder as OrmBuilder;
...
class Builder
{
     ...
     *
     * @var \FluentSupport\Framework\Database\Query\IndexHint
     */
    public $indexHint;
     ...
     * @param  \FluentSupport\Framework\Database\Query\Grammars\Grammar|null  $grammar
     * @param  \FluentSupport\Framework\Database\Query\Processors\Processor|null  $processor
     * @return void
     */
     ...
     *
     * @param  \Closure|\FluentSupport\Framework\Database\Query\Builder|\FluentSupport\Framework\Database\Orm\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Closure|\FluentSupport\Framework\Database\Query\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \FluentSupport\Framework\Database\Query\Builder  $parentQuery
     * @param  string  $type
     * @param  string  $table
     * @return \FluentSupport\Framework\Database\Query\JoinClause
     */
     ...
     * @param  string  $type
     * @param  string  $table
     * @return \FluentSupport\Framework\Database\Query\JoinLateralClause
     */
     ...
     *
     * @param  \Closure|string|array|\FluentSupport\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  \FluentSupport\Framework\Database\Query\Expression|string  $column
     * @param  string  $value
     ...
     *
     * @param  string  $column
     * @param  \FluentSupport\Framework\Support\ArrayableInterface|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  \FluentSupport\Framework\Database\Query\Builder  $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \FluentSupport\Framework\Database\Query\Expression[]|string[]  $columns
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  \Closure|\FluentSupport\Framework\Database\Orm\Builder|\FluentSupport\Framework\Database\Query\Builder|\FluentSupport\Framework\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\FluentSupport\Framework\Database\Query\Builder|\FluentSupport\Framework\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \FluentSupport\Framework\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     * @return mixed
     *
     * @throws \FluentSupport\Framework\Database\RecordsNotFoundException
     * @throws \FluentSupport\Framework\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  \FluentSupport\Framework\Support\Collection  $items
     * @return \FluentSupport\Framework\Support\Collection
     */
     ...
     * @return \FluentSupport\Framework\Pagination\LengthAwarePaginatorInterface
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \FluentSupport\Framework\Pagination\PaginatorInterface
     */
     ...
     * @param  \FluentSupport\Framework\Pagination\Cursor|string|null  $cursor
     * @return \FluentSupport\Framework\Pagination\CursorPaginatorInterface
     */
     ...
     *
     * @return \FluentSupport\Framework\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \FluentSupport\Framework\Database\Query\Grammars\Grammar
     */
