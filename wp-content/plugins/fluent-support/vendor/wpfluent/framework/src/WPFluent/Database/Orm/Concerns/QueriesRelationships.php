...
trait QueriesRelationships
{
     ...
     *
     * @param  \FluentSupport\Framework\Database\Orm\Relations\Relation|string  $relation
     ...
     *
     * @param  \FluentSupport\Framework\Database\Orm\Relations\MorphTo  $relation
     * @param  string  $type
     ...
     *
     * @param  \FluentSupport\Framework\Database\Orm\Builder  $hasQuery
     * @param  \FluentSupport\Framework\Database\Orm\Relations\Relation  $relation
     * @param  string  $operator
     * @param  int  $count
     * @param  string  $boolean
     ...
     *
     * @param  \FluentSupport\Framework\Database\Orm\Builder  $from
     * @return \FluentSupport\Framework\Database\Orm\Builder|static
     */
