...
use FluentSupport\Framework\Database\RecordsNotFoundException;
...
use FluentSupport\Framework\Database\Orm\RelationNotFoundException;
use FluentSupport\Framework\Database\Orm\Concerns\QueriesRelationships;
 ...
 *
 * @mixin \FluentSupport\Framework\Database\Query\Builder
 *
 * @template TModel of \FluentSupport\Framework\Database\Orm\Model
 */
class Builder
{
     ...
     *
     * @var \FluentSupport\Framework\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \FluentSupport\Framework\Database\Orm\Model
     */
    protected $model;
     ...
     * @param  \FluentSupport\Framework\Database\Orm\Scope|\Closure  $scope
     * @return $this
     */
     ...
     * @param  mixed  $value
     * @param  string  $boolean
     * @return \FluentSupport\Framework\Database\Orm\Model|static|null
     */
     ...
     *
     * @param  \Closure|array|string|\FluentSupport\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  (\Closure(static): mixed)|string|array|\FluentSupport\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  (\Closure(static): mixed)|array|string|\FluentSupport\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentSupport\Framework\Database\Orm\Model|\FluentSupport\Framework\Database\Orm\Collection|static[]|static|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentSupport\Framework\Database\Orm\Model|\FluentSupport\Framework\Database\Orm\Collection|static|static[]
     *
     ...
     * @return TModel|TValue|\FluentSupport\Framework\Database\Orm\Collection
     */
     ...
     * @return mixed
     *
     * @throws \FluentSupport\Framework\Database\Orm\ModelNotFoundException<TModel>
     * @throws \FluentSupport\Framework\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  array|string  $columns
     * @return \FluentSupport\Framework\Database\Orm\Collection|static[]
     */
     ...
     *
     * @param  array  $attributes
     * @return \FluentSupport\Framework\Database\Orm\Model|$this
     */
     ...
     *
     * @param  array|\FluentSupport\Framework\Database\Query\Expression  $columns
     * @return array
     */
