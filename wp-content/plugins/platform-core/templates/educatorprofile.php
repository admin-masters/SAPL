...
.pc-offer-inputs{margin-top:16px;}
.pc-input{
    width:100%;
    margin-top:10px;
    padding:12px 14px;
...
<!-- NOTE: No header/navbar here. The navbar is injected by the PHP shortcode. -->
...
<div class="card">
    ...
    <div class="calendar">
        ...
        <!-- JS populates this; PHP regex clears it before JS runs -->
        <div class="dates"></div>
    </div>
    ...
    <div class="section">
        ...
        <div class="duration">
            <div>30 mins</div>
            <div>60 mins</div>
            <div class="active">90 mins</div>
        </div>
    </div>

    <div class="section">
        <h4>Available Time Slots</h4>
        <p style="font-size:12px;color:#64748b;margin-bottom:8px;">Select a date from the calendar to view available slots.</p>
        <!-- JS populates this -->
        <div class="slots"></div>
    </div>

    <div class="section pc-offer-inputs">
        <h4>Class details</h4>
        ...
        <input
            type="number"
            id="pc-offered-price"
            placeholder="Enter offered price - optional"
            class="pc-input"
            min="0"
        />
    </div>
...
<div class="footer-note">
    &copy; 2024 MedEd Platform. All rights reserved.
</div>
</div><!-- /container -->
